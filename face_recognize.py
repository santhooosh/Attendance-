...
##gmail_user = "sjcesa23@gmail.com"
##gmail_pwd = "12assjce"
##FROM = 'sjcesa23@gmail.com'
##TO = ['harshaahsrah00@gmail.com'] #must be a list
...
a2=0;
a3=0;
##url="http://192.168.43.9:8080/shot.jpg"
count = 0
while True:
...
##    im=cv2.imdecode(imgNp,-1)
    ...
    for (x,y,w,h) in faces:
        ...
        if prediction[1]<500:
            ...
            if name_identified == 'santhosh':
                playsound('soundsan.mp3')
